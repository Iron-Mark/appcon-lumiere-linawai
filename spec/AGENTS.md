...
| [`spec-03-demo-ship`](./spec-03-demo-ship/) | active | `spec-02-gemini-adapt` | Production URL whose golden path is a live model call. Fixture on a real notice fails the ship |
| [`spec-04-taglish-fidelity`](./spec-04-taglish-fidelity/) | active | `spec-02-gemini-adapt`, `spec-03-demo-ship` | Research plan from 20 live clarifications: Taglish must not raise a false Meaning Check |
