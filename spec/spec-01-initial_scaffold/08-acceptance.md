...
1. Onboarding: set **Key Points + Plain Language + Read**. Leave Auto-Clarify off unless explicitly testing that opt-in.
2. Open/paste or load the campus-pilot source via fixture.
3. Clarified note appears in the reading workspace (Granola-style measure).
...
8. Extension can apply or request the same clarification (manual path minimum; Auto-Clarify only when the user opts in).
