  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        ...
        // Scrim fades ~200ms (opacity only). Radix uses data-state, not data-open.
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Full-panel slide via transform; open ~280ms ease-out, close ~200ms.
          "duration-[280ms] ease-out data-[state=closed]:duration-200",
